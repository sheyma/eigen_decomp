...
#out_prec = "%g"
#np.savetxt(out_prfx + "embed.csv", embedding, fmt=out_prec, delimiter='\t', 
#newline='\n')
#np.savetxt(out_prfx + "lambd.csv", result['lambdas'], fmt=out_prec, delimiter='\t', 
#newline='\n')
#np.savetxt(out_prfx + "vect.csv", result['vectors'], fmt=out_prec, delimiter='\t', 
#newline='\n')
